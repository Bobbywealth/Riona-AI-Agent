...
// Proxy configuration
export const PROXY_ENABLED: boolean = process.env.PROXY_ENABLED === 'true';
export const PROXY_HOST: string = process.env.PROXY_HOST || '';
export const PROXY_PORT: string = process.env.PROXY_PORT || '';
